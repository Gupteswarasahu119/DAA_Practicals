...
int main()
{
    ...
    std::chrono::duration<double, std::nano> durationIter =
        endIter - startIter;
    ...
    std::chrono::duration<double, std::nano> durationRec =
        endRec - startRec;
    ...
    std::cout << "Iterative Time : "
              << durationIter.count() << " ns" << std::endl;

    std::cout << "-------------------------------" << std::endl;

    std::cout << "Recursive Result : " << resRec << std::endl;
    std::cout << "Recursive Time : "
              << durationRec.count() << " ns" << std::endl;

    std::cout << "Gupteswara Sahu\n";
    std::cout << "92460118119\n";
    std::cout << "5-EN18\n";
